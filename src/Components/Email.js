...
const Email = () => {
  return (
    <div className='border-2 border-red-900 m-5 bg-mail rounded-xl text-center relative -bottom-44 md:w-2/3 md:mx-auto '>
      ...
      <input
        ...
        className='w-11/12 md:w-2/4 rounded-3xl h-12 md:h-14 md:mx-6 my-5 p-5'
      />
